...
$Page_NetworkUsage = New-UDPage -Name NetworkUsage -Icon wifi -Title "Network usage" -Content {New-UDImage -Path $env:HOME/boatdata/datausage.png -Width 320 -Height 240}
