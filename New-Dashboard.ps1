...
$Page_Map = New-UDPage -Name Map -Icon map -Title "Map" -Content {New-UDIFrame -Id GuleSiderMap -Uri "https://kart.gulesider.no/?c=$($Data.GPS.Latitude),$($Data.GPS.Longtitude)&z=15&l=nautical&fs=true"}
